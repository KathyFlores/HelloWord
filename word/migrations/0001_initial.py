...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('familiar_level', models.IntegerField(default=0, choices=[(0, '不认识'), (1, '见过'), (2, '知道意思'), (3, '初步掌握'), (4, '完全掌握'), (5, '熟记')], validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, upload_to=word.models.wordset_cover_path)),
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ManyToManyField(to='word.Word', through='word.Learn'),
        ),
        migrations.AddField(
            model_name='userprofile',
        ...
        migrations.AddField(
            model_name='userprofile',
            name='word_sets',
            field=models.ManyToManyField(to='word.WordSet'),
        ),
